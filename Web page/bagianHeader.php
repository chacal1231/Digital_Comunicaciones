...
<head>
    ...
    <title>UN ECO HOGAR Panel</title>
                        ...
                        <ul class="sidebar-menu" id="nav-accordion">
                            ...
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    ...
                                    <li><a href="?page=luz">Nivel de luz</a></li>
                                    <li><a href="?page=crecimiento">Etapa de crecimiento</a></li>
                                    <li><a href="?page=agua">Detector de agua/Nivel de agua</a></li>
                                    <li><a href="?page=potencia">Potencia consumida/Costo</a></li> 
                                    <li><a href="?page=panel">Panel solar</a></li>
                                    <li><a href="?page=material">Material reciclado</a></li>  
                                </ul>
                            </li>
