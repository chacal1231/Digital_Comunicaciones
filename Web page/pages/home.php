...
<div class="row">
    <div class="col-md-3">
        <div class="mini-stat clearfix">
            <font size="1"><b>Temperatura</b></font>
    ...
    <div class="col-md-3">
        <div class="mini-stat clearfix">
            <font size="1"><b>Panel Solar</b></font> 
            <span class="mini-stat-icon pink"><i class="fa fa-sun-o"></i></span>
            <div class="mini-stat-info">
            <button type="button" class="btn btn-info btn-xs"><?=$t?>°</button><font size="2"> Posicion (Tetha)</font><br>
                <button type="button" class="btn btn-danger btn-xs"><?=$f?>°</button><font size="2"> Posicion (Fhi)</font>  
            </div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="mini-stat clearfix">
            <font size="1"><b>Etapa de crecimiento</b></font>
            <span class="mini-stat-icon green"><i class="fa fa-pagelines"></i></span>
            <div class="mini-stat-info">
   ...
   <body>
    <?php
        ...
        if ($result_graph) {
            ...
            $arrData = array(
                  "chart" => array(
                  "caption" => "Temperaturas más altas",
    ...
    /*Create an object for the column chart using the FusionCharts PHP class constructor. Syntax for the constructor is ` FusionCharts("type of chart", "unique chart id", width of the chart, height of the chart, "div id to render the chart", "data format", "data source")`. Because we are using JSON data to render the chart, the data format will be `json`. The variable `$jsonEncodeData` holds all the JSON data for the chart, and will be passed as the value for the data source parameter of the constructor.*/
            ...
            $columnChart = new FusionCharts("line", "myFirstChart" , 500, 300, "chart-1", "json", $jsonEncodedData);
        ...
        <section class="panel">
            ...
            <div class="panel-body"> 
                <div class="table-responsive">
                    ...
                    "toolTipPadding"=> "5",
                    "caption" => "Etapa de crecimiento de la planta",
                    "yAxisName"=> "Etapa",
                    "xAxisName"=> "Fecha",
                    "bgColor" => "#ffffff",
                    "showlabels" => "1",
